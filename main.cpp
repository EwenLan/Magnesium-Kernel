...
extern int* GetPorts();
enum status_type{standing_by, error, busy, started, unavaliable=-1};
enum module_type{kernel=1, ui=3, camera=5, nn=7, payment=9, database=2};
enum message_type{pid, error, start, cancel, quit, img_path, take_photo, img_content, pay_success, pay_fail};
...
//  pid            error          start          cancel         quit           img_path       take_photo     img_content    pay_success    pay_fail
    law[0][0] = 0; law[0][1] = 0; law[0][2] = 0; law[0][3] = 0; law[0][4] = 0; law[0][5] = 0; law[0][6] = 0; law[0][7] = 0; law[0][8] = 0; law[0][9] = 0; //none
    law[1][0] = 1; law[1][1] = 1; law[1][2] = 1; law[1][3] = 1; law[1][4] = 1; law[1][5] = 1; law[1][6] = 1; law[1][7] = 1; law[1][8] = 1; law[1][9] = 1; //kernel
    law[2][0] = 0; law[2][1] = 0; law[2][2] = 0; law[2][3] = 0; law[2][4] = 0; law[2][5] = 0; law[2][6] = 0; law[2][7] = 0; law[2][8] = 0; law[2][9] = 0; //database
    law[3][0] = 0; law[3][1] = 0; law[3][2] = 0; law[3][3] = 0; law[3][4] = 0; law[3][5] = 0; law[3][6] = 0; law[3][7] = 0; law[3][8] = 0; law[3][9] = 0; //ui
    law[4][0] = 0; law[4][1] = 0; law[4][2] = 0; law[4][3] = 0; law[4][4] = 0; law[4][5] = 0; law[4][6] = 0; law[4][7] = 0; law[4][8] = 0; law[4][9] = 0; //none
    law[5][0] = 0; law[5][1] = 0; law[5][2] = 0; law[5][3] = 0; law[5][4] = 0; law[5][5] = 0; law[5][6] = 0; law[5][7] = 0; law[5][8] = 0; law[5][9] = 0; //camera
    law[6][0] = 0; law[6][1] = 0; law[6][2] = 0; law[6][3] = 0; law[6][4] = 0; law[6][5] = 0; law[6][6] = 0; law[6][7] = 0; law[6][8] = 0; law[6][9] = 0; //none
    law[7][0] = 0; law[7][1] = 0; law[7][2] = 0; law[7][3] = 0; law[7][4] = 0; law[7][5] = 0; law[7][6] = 0; law[7][7] = 0; law[7][8] = 0; law[7][9] = 0; //nn
    law[8][0] = 0; law[8][1] = 0; law[8][2] = 0; law[8][3] = 0; law[8][4] = 0; law[8][5] = 0; law[8][6] = 0; law[8][7] = 0; law[8][8] = 0; law[8][9] = 0; //none
    law[9][0] = 0; law[9][1] = 0; law[9][2] = 0; law[9][3] = 0; law[9][4] = 0; law[9][5] = 0; law[9][6] = 0; law[9][7] = 0; law[9][8] = 0; law[9][9] = 0; //payment
...
int main(int argc, char* argv[])
{
    ...
    for(auto &i : pid_table)
        i = -1;
    std::thread testSubTask(RunModule, "python ./test-sub-task.py 2334 2335");// module: database
